...
import it.polimi.ingsw.am02.common.messages.events.heartbeat.HeartbeatEvent;
 ...
 * {@link VirtualView} method, eliminating switch logic in client-side
 * transport handlers.
 *
 * <p>Subtypes are grouped into:
 * <ul>
 *   <li>{@link LobbyEvent} — pre-game lobby notifications</li>
 *   <li>{@link GameEvent} — in-game state notifications</li>
 *   <li>{@link ErrorEvent} — error responses</li>
 *   <li>{@link HeartbeatEvent} — liveness probes ({@link PingEvent},
 *       {@link PongEvent}), handled at the transport layer</li>
 * </ul>
 */
...
public sealed interface Event extends Message
        permits LobbyEvent, GameEvent, ErrorEvent, HeartbeatEvent {
