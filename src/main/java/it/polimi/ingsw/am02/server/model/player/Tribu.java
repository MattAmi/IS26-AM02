...
public class Tribu {
    ...
    /**
     * Creates a new, empty Tribu with all resource counters initialized to zero.
    ...
    public List<BuildingEffect> getActiveBuildingEffects() {return activeBuildingEffects; } // For testing
}